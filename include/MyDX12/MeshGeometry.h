...
struct MeshGeometry {
  ...
  DXGI_FORMAT IndexFormat =
      DXGI_FORMAT_R16_UINT;      // DXGI_FORMAT_R16_UINT / DXGI_FORMAT_R32_UINT
  ...
  // dynamic
  // upload + map
  void InitBuffer(ID3D12Device* device, const void* vb_data, UINT vb_count,
                  UINT vb_stride, const void* ib_data, UINT ib_count,
