...
void DX12::GCmdList::ResourceBarrier(ID3D12Resource* resource,
...
void DX12::GCmdList::ClearRenderTargetView(
...
void DX12::GCmdList::ClearDepthStencilView(
...
void DX12::GCmdList::DrawIndexed(UINT IndexCount, UINT StartIndexLocation,
