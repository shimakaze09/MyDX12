...
void MyDX12::MeshGPUBuffer::InitBuffer(ID3D12Device* device,
  ...
  ThrowIfFailed(VertexBufferGPU->Map(
      0, nullptr, reinterpret_cast<void**>(&VertexBufferMappedData)));
  ...
  ThrowIfFailed(IndexBufferGPU->Map(
      0, nullptr, reinterpret_cast<void**>(&IndexBufferMappedData)));
